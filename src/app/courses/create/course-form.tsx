...
export default function CourseForm({ instructorId }: CourseFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label className="block text-sm font-medium mb-2">コースタイトル</label>
        <input
          type="text"
          required
      ...
      <div>
        <label className="block text-sm font-medium mb-2">動画</label>
        <VideoUpload courseId="temp" onUploadComplete={handleVideoUpload} />
        {formData.videoUrl && (
